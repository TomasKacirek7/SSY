...
// Makra pro nastavení, zrušení a XOR bitu
...
int main(void)
{
	...
	//PORTB = 0b00000000;
	//_delay_loop_2(0xFFFF);
	// Nastavení pin? 4, 5, 6 na portu B jako výstupy (DDRB = 0b01111000)
	DDRB = 0b01111000;  // Nastaví piny 4, 5, 6 jako výstupy (pro LED na bitech 4, 5, 6)
